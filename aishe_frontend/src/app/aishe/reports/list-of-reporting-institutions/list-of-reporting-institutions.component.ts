...
@Component({
  selector: 'app-list-of-reporting-institutions',
  templateUrl: './list-of-reporting-institutions.component.html',
  styleUrls: ['./list-of-reporting-institutions.component.scss']
})
export class ListOfReportingInstitutionsComponent implements OnInit {
...
this.formControl();
  ...
  formControl(){
    ...
    this.reportFormlistofInst = this.fb.group({
      ...
      this.reportFormlistofInst.get('institution')?.setValue('College');
