...
export class Report5Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport5(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport5(this.reportFormlistofInst.value).pipe(
      finalize(() => {
