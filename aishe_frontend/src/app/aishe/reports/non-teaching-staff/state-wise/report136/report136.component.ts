...
@Component({
  selector: 'app-report136',
  templateUrl: './report136.component.html',
  styleUrls: ['./report136.component.scss']
})
export class Report136Component implements OnInit ,ReportChildComponent {
...
stateCodeDeafult:any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport136(this.reportFilterForm.value).subscribe(
        (res:any) => {
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport136(this.reportFilterForm.value).subscribe((res:any) => {
