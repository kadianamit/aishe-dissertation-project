...
@Component({
  ...
  styleUrls: ['./report23.component.scss']
})
export class Report23Component implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    // }
    this.reportService.getReport23(this.reportFilterForm.value).subscribe(
      res => {
  ...
  exportAsXLSX(): void {
    ...
    //     this.reportFilterForm.value.defaultState = this.stateCodeDeafult;
    // }
    this.reportService.getReport23(this.reportFilterForm.value).subscribe(res => {
