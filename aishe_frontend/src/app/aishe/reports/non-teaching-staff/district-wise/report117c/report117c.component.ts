...
@Component({
  selector: 'app-report117c',
  templateUrl: './report117c.component.html',
  styleUrls: ['./report117c.component.scss']
})
export class Report117cComponent implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport117C(this.reportFilterForm.value).subscribe(res=>{
 ...
 this.reportFilterForm.value=this.reportFilterForm.getRawValue();
  ...
  ngOnInit(): void {
    console.log("inside reports117c")
