...
@Component({
  selector: 'app-report117b',
  templateUrl: './report117b.component.html',
  styleUrls: ['./report117b.component.scss']
})
export class Report117bComponent implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
      ...
      this.reportService.getReport117B(this.reportFilterForm.value).subscribe(
      res => {
 ...
 this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport117B(this.reportFilterForm.value).subscribe(res => {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport117B(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
  ...
  ngOnInit(): void {
    console.log("inside reports117b")
