...
@Component({
  selector: 'app-report117a',
  templateUrl: './report117a.component.html',
  styleUrls: ['./report117a.component.scss']
})
export class Report117aComponent implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport117A(this.reportFilterForm.value).subscribe((res)=>{
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport117A(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
  ...
  ngOnInit(): void {
    console.log("inside reports117a")
