...
@Component({
  selector: 'app-report117',
  templateUrl: './report117.component.html',
  styleUrls: ['./report117.component.scss']
})
export class Report117Component implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport117(this.reportFilterForm.value).subscribe(
     res => {
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport117(this.reportFilterForm.value).subscribe(res => {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport117(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
