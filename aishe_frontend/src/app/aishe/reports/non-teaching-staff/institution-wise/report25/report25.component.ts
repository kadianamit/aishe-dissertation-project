...
@Component({
  selector: 'app-report25',
  templateUrl: './report25.component.html',
  styleUrls: ['./report25.component.scss']
})
export class Report25Component implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport25(this.reportFilterForm.value).subscribe(
      res=>{
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.reportService.getReport25(this.reportFilterForm.value).subscribe(res => {
