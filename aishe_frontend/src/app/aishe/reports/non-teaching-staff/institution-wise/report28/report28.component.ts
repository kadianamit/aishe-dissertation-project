...
@Component({
  selector: 'app-report28',
  templateUrl: './report28.component.html',
  styleUrls: ['./report28.component.scss']
})
export class Report28Component implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport28(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport28(this.reportFilterForm.value).subscribe(res => {
