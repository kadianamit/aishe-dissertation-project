...
@Component({
  selector: 'app-report27',
  templateUrl: './report27.component.html',
  styleUrls: ['./report27.component.scss']
})
export class Report27Component implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport27(this.reportFilterForm.value).subscribe(
      res=>{
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport27(this.reportFilterForm.value).subscribe(res => {
