...
@Component({
  selector: 'app-report30',
  templateUrl: './report30.component.html',
  styleUrls: ['./report30.component.scss']
})
export class Report30Component implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport30(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport30(this.reportFilterForm.value).subscribe(res => {
