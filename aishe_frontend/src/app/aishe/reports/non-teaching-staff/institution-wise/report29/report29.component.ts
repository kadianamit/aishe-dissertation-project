...
@Component({
  selector: 'app-report29',
  templateUrl: './report29.component.html',
  styleUrls: ['./report29.component.scss']
})
export class Report29Component implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport29(this.reportFilterForm.value).subscribe(
      res=>{
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport29(this.reportFilterForm.value).subscribe(res => {
