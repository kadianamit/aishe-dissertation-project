...
@Component({
  selector: 'app-report26',
  templateUrl: './report26.component.html',
  styleUrls: ['./report26.component.scss']
})
export class Report26Component implements OnInit, ReportChildComponent{
  ...
  getReportDataTable(): void {
   ...
   this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.reportService.getReport26(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    this.reportFilterForm.value.exportType="PDF";
       this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.reportService.getReport26(this.reportFilterForm.value).subscribe(res => {
