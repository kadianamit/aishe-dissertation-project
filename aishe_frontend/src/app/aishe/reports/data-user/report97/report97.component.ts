...
@Component({
  selector: 'app-report97',
  templateUrl: './report97.component.html',
  styleUrls: ['./report97.component.scss']
})
export class Report97Component implements OnInit,ReportChildComponent {
...
this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport97(this.reportFormlistofInst.value).subscribe(res => {
...
this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport97(this.reportFormlistofInst.value).pipe(
      finalize(() => {
