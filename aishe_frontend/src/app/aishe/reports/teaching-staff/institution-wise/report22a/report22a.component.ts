...
@Component({
  selector: 'app-report22a',
  templateUrl: './report22a.component.html',
  styleUrls: ['./report22a.component.scss']
})
export class Report22aComponent implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getreport22A(this.reportFilterForm.value).subscribe((res:any) => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report22a")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getreport22A(this.reportFilterForm.value).pipe(
      finalize(()=>{
      ...
      (res:any) => {
        ...
        // console.log("getReportUniversityBasicData ",res);
