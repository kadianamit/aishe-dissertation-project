...
@Component({
  selector: 'app-report19',
  templateUrl: './report19.component.html',
  styleUrls: ['./report19.component.scss']
})
export class Report19Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport19(this.reportFilterForm.value).subscribe((res:any) => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report19")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport19(this.reportFilterForm.value).pipe(
      finalize(()=>{
