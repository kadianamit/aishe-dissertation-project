...
@Component({
  selector: 'app-report22',
  templateUrl: './report22.component.html',
  styleUrls: ['./report22.component.scss']
})
export class Report22Component implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport22(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport22(this.reportFilterForm.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport22(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
