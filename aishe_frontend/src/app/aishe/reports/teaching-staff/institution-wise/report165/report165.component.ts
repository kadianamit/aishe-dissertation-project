...
@Component({
  selector: 'app-report165',
  templateUrl: './report165.component.html',
  styleUrls: ['./report165.component.scss']
})
export class Report165Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport165(this.reportFilterForm.value).subscribe((res:any) => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report165")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport165(this.reportFilterForm.value).pipe(
      finalize(()=>{
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport165(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
