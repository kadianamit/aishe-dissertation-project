...
@Component({
  selector: 'app-report137',
  templateUrl: './report137.component.html',
  styleUrls: ['./report137.component.scss']
})
export class Report137Component implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport137(this.reportFilterForm.value).subscribe((res:any) => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside reports137")
