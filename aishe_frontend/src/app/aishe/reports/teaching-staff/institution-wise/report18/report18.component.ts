...
@Component({
  selector: 'app-report18',
  templateUrl: './report18.component.html',
  styleUrls: ['./report18.component.scss']
})
export class Report18Component implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport18(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportFilterForm.value.exportType = "JSON";
     this.reportFilterForm.value.universityId=this.splitAisheCode
    this.reportService.getReport18(this.reportFilterForm.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    ...
    this.reportFilterForm.value.exportType="PDF";
     this.reportFilterForm.value.universityId=this.splitAisheCode
    this.reportService.getReport18(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
