...
@Component({
  selector: 'app-report20',
  templateUrl: './report20.component.html',
  styleUrls: ['./report20.component.scss']
})
export class Report20Component implements OnInit , ReportChildComponent {
  ...
  this.reportFilterForm.value.reportType="EXCEL";
    this.reportService.getreport20Data(this.reportFilterForm.value).subscribe((res:any) => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report20")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getreport20Data(this.reportFilterForm.value).pipe(
      finalize(()=>{
