...
@Component({
  selector: 'app-report166',
  templateUrl: './report166.component.html',
  styleUrls: ['./report166.component.scss']
})
export class Report166Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport166(this.reportFilterForm.value).subscribe((res:any) => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report166")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport166(this.reportFilterForm.value).pipe(
      finalize(()=>{
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport166(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
