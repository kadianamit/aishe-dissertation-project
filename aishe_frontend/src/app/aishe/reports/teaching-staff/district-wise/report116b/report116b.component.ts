...
@Component({
  selector: 'app-report116b',
  templateUrl: './report116b.component.html',
  styleUrls: ['./report116b.component.scss']
})
export class Report116bComponent implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getDistrictCategoryAndGenderWiseTeacherCollegeDataPdf(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report116b")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getDistrictCategoryAndGenderWiseTeacherCollegeData(this.reportFilterForm.value).pipe(
      finalize(() => {
