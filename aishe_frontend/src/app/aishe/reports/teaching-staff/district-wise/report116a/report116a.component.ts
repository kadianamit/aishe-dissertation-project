...
@Component({
  selector: 'app-report116a',
  templateUrl: './report116a.component.html',
  styleUrls: ['./report116a.component.scss']
})
export class Report116aComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getDistrictCategoryAndGenderWiseTeacherUniversityPdf(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
          utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
    })
  }
  ngOnInit(): void {
    console.log("inside report116a")
  }
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getdistrictCategoryAndGenderWiseTeacherUniversity(this.reportFilterForm.value).pipe(
      finalize(() => {
