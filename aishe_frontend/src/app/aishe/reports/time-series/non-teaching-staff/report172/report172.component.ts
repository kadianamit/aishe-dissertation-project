...
@Component({
  selector: 'app-report172',
  templateUrl: './report172.component.html',
  styleUrls: ['./report172.component.scss']
})
export class Report172Component implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport172(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport172(this.reportFilterForm.value).subscribe(res => {
