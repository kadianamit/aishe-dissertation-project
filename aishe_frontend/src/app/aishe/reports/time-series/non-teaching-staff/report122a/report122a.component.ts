...
@Component({
  selector: 'app-report122a',
  templateUrl: './report122a.component.html',
  styleUrls: ['./report122a.component.scss']
})
export class Report122aComponent implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport122A(this.reportFilterForm.value).subscribe(
     res => {
...
// debugger
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport122A(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports122A")
