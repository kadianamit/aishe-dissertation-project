...
@Component({
  selector: 'app-report122',
  templateUrl: './report122.component.html',
  styleUrls: ['./report122.component.scss']
})
export class Report122Component implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport122(this.reportFilterForm.value).subscribe(
     res => {
...
this.handlePageChange(1);
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport122(this.reportFilterForm.value).subscribe(res => {
