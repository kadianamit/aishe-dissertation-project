...
@Component({
  selector: 'app-report122c',
  templateUrl: './report122c.component.html',
  styleUrls: ['./report122c.component.scss']
})
export class Report122cComponent implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport122C(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport122C(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports122C")
