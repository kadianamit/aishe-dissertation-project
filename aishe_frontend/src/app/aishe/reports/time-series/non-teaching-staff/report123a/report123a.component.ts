...
@Component({
  selector: 'app-report123a',
  templateUrl: './report123a.component.html',
  styleUrls: ['./report123a.component.scss']
})
export class Report123aComponent implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport123A(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport123A(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports123A")
