...
@Component({
  selector: 'app-report123c',
  templateUrl: './report123c.component.html',
  styleUrls: ['./report123c.component.scss']
})
export class Report123cComponent implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport123C(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport123C(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports123C")
