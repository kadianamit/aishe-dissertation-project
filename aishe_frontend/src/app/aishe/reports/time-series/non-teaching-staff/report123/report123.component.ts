...
export class Report123Component implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport123(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport123(this.reportFilterForm.value).subscribe(res => {
