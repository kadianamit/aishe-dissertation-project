...
@Component({
  selector: 'app-report100',
  templateUrl: './report100.component.html',
  styleUrls: ['./report100.component.scss']
})
export class Report100Component implements OnInit, ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport100(this.reportFilterForm.value,this.inputObj).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport100(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
