...
@Component({
  selector: 'app-report104a',
  templateUrl: './report104a.component.html',
  styleUrls: ['./report104a.component.scss']
})
export class Report104aComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport104A(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport104A(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
