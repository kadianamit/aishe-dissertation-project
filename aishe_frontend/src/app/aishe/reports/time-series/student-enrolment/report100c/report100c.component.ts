...
@Component({
  selector: 'app-report100c',
  templateUrl: './report100c.component.html',
  styleUrls: ['./report100c.component.scss']
})
export class Report100cComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport100C(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport100C(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
