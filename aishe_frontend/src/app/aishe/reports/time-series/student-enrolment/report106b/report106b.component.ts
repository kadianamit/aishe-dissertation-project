...
@Component({
  selector: 'app-report106b',
  templateUrl: './report106b.component.html',
  styleUrls: ['./report106b.component.scss']
})
export class Report106bComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport106B(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport106B(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
