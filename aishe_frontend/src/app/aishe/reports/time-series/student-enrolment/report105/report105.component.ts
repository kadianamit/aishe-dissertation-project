...
@Component({
  selector: 'app-report105',
  templateUrl: './report105.component.html',
  styleUrls: ['./report105.component.scss']
})
export class Report105Component implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport105(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport105(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
