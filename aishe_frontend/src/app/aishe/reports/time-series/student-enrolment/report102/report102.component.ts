...
@Component({
  selector: 'app-report102',
  templateUrl: './report102.component.html',
  styleUrls: ['./report102.component.scss']
})
export class Report102Component implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport102(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport102(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
