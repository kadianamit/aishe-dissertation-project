...
@Component({
  selector: 'app-report104',
  templateUrl: './report104.component.html',
  styleUrls: ['./report104.component.scss']
})
export class Report104Component implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport104(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport104(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
