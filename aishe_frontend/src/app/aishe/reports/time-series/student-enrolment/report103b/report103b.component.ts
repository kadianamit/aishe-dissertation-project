...
@Component({
  selector: 'app-report103b',
  templateUrl: './report103b.component.html',
  styleUrls: ['./report103b.component.scss']
})
export class Report103bComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport103B(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport103B(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
