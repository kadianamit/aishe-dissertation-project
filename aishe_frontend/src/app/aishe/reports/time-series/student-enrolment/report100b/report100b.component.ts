...
@Component({
  selector: 'app-report100b',
  templateUrl: './report100b.component.html',
  styleUrls: ['./report100b.component.scss']
})
export class Report100bComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport100B(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports100b")
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport100B(this.reportFilterForm.value , this.inputObj).pipe(
      finalize(() => {
