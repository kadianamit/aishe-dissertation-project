...
@Component({
  selector: 'app-report101a',
  templateUrl: './report101a.component.html',
  styleUrls: ['./report101a.component.scss']
})
export class Report101aComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport101A(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport101A(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
