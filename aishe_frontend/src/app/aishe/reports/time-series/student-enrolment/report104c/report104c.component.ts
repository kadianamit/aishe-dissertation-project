...
@Component({
  selector: 'app-report104c',
  templateUrl: './report104c.component.html',
  styleUrls: ['./report104c.component.scss']
})
export class Report104cComponent implements OnInit  , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport104C(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport104C(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
