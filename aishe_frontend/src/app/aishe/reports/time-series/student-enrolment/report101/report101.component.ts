...
@Component({
  ...
  styleUrls: ['./report101.component.scss']
})
export class Report101Component implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport101(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport101(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
        ...
        this.reportTableData.length =null;
