...
@Component({
  selector: 'app-report105b',
  templateUrl: './report105b.component.html',
  styleUrls: ['./report105b.component.scss']
})
export class Report105bComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport105B(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport105B(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
