...
@Component({
  selector: 'app-report106',
  templateUrl: './report106.component.html',
  styleUrls: ['./report106.component.scss']
})
export class Report106Component implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport106(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport106(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
