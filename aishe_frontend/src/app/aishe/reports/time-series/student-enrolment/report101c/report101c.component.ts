...
@Component({
  selector: 'app-report101c',
  templateUrl: './report101c.component.html',
  styleUrls: ['./report101c.component.scss']
})
export class Report101cComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport101C(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport101C(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
