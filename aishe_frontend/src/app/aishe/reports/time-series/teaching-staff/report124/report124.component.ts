...
@Component({
  selector: 'app-report124',
  templateUrl: './report124.component.html',
  styleUrls: ['./report124.component.scss']
})
export class Report124Component implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport124(this.reportFilterForm.value).subscribe(
     res => {
...
// debugger
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport124(this.reportFilterForm.value).subscribe(res => {
