...
@Component({
  selector: 'app-report124a',
  templateUrl: './report124a.component.html',
  styleUrls: ['./report124a.component.scss']
})
export class Report124aComponent implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport124A(this.reportFilterForm.value).subscribe(
     res => {
...
// debugger
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport124A(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports124A")
