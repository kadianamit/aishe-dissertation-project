...
@Component({
  selector: 'app-report124c',
  templateUrl: './report124c.component.html',
  styleUrls: ['./report124c.component.scss']
})
export class Report124cComponent implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport124C(this.reportFilterForm.value).subscribe(
     res => {
...
// debugger
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport124C(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports124C")
