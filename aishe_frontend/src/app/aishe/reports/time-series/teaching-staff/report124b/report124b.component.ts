...
@Component({
  selector: 'app-report124b',
  templateUrl: './report124b.component.html',
  styleUrls: ['./report124b.component.scss']
})
export class Report124bComponent implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport124B(this.reportFilterForm.value).subscribe(
     res => {
...
// debugger
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport124B(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports124B")
