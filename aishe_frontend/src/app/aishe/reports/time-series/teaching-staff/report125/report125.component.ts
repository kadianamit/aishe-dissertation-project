...
@Component({
  selector: 'app-report125',
  templateUrl: './report125.component.html',
  styleUrls: ['./report125.component.scss']
})
export class Report125Component implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport125(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport125(this.reportFilterForm.value).subscribe(res => {
