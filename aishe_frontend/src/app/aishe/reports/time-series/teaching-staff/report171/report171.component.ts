...
@Component({
  selector: 'app-report171',
  templateUrl: './report171.component.html',
  styleUrls: ['./report171.component.scss']
})
export class Report171Component implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport171(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport171(this.reportFilterForm.value).subscribe(res => {
