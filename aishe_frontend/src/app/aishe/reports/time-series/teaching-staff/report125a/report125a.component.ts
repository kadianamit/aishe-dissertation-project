...
@Component({
  selector: 'app-report125a',
  templateUrl: './report125a.component.html',
  styleUrls: ['./report125a.component.scss']
})
export class Report125aComponent implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport125A(this.reportFilterForm.value).subscribe(
     res => {
...
// debugger
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport125A(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports125A")
