...
@Component({
  selector: 'app-report125b',
  templateUrl: './report125b.component.html',
  styleUrls: ['./report125b.component.scss']
})
export class Report125bComponent implements OnInit, ReportChildComponent {
  reportTableData: any;
  tableColumns: any;
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport125B(this.reportFilterForm.value).subscribe(
     res => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportService.getReport125B(this.reportFilterForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports125B")
