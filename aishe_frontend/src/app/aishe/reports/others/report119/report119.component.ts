...
@Component({
  selector: 'app-report119',
  templateUrl: './report119.component.html',
  styleUrls: ['./report119.component.scss']
})
export class Report119Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport119(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport119(this.reportFilterForm.value).pipe(
      finalize(() => {
