...
@Component({
  selector: 'app-report114',
  templateUrl: './report114.component.html',
  styleUrls: ['./report114.component.scss']
})
export class Report114Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport114(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport114(this.reportFilterForm.value).pipe(
      finalize(() => {
