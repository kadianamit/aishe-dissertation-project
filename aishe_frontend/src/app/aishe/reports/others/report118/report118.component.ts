...
@Component({
  selector: 'app-report118',
  templateUrl: './report118.component.html',
  styleUrls: ['./report118.component.scss']
})
export class Report118Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport118(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport118(this.reportFilterForm.value).pipe(
      finalize(() => {
