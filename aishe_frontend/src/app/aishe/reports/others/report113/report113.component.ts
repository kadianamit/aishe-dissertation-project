...
@Component({
  selector: 'app-report113',
  templateUrl: './report113.component.html',
  styleUrls: ['./report113.component.scss']
})
export class Report113Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport113(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport113(this.reportFilterForm.value).pipe(
      finalize(() => {
