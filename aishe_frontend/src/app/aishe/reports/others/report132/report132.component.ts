...
@Component({
  selector: 'app-report132',
  templateUrl: './report132.component.html',
  styleUrls: ['./report132.component.scss']
})
export class Report132Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport132(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport132(this.reportFilterForm.value).pipe(
      finalize(() => {
