...
@Component({
  selector: 'app-report130',
  templateUrl: './report130.component.html',
  styleUrls: ['./report130.component.scss']
})
export class Report130Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport130(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport130(this.reportFilterForm.value).pipe(
      finalize(() => {
