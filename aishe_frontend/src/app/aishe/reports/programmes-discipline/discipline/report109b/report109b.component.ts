...
@Component({
  selector: 'app-report109b',
  templateUrl: './report109b.component.html',
  styleUrls: ['./report109b.component.scss']
})
export class Report109bComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport109B(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports109b")
  ...
  getReportDataTable(): void {
    ...
    this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.getService.getReport109B(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.getService.getReport109B(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
