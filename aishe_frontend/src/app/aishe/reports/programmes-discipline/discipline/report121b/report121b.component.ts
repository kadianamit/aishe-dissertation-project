...
@Component({
  selector: 'app-report121b',
  templateUrl: './report121b.component.html',
  styleUrls: ['./report121b.component.scss']
})
export class Report121bComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport121B(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports121b")
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport121B(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport121B(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
