...
@Component({
  selector: 'app-report121a',
  templateUrl: './report121a.component.html',
  styleUrls: ['./report121a.component.scss']
})
export class Report121aComponent implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport121A(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports121a")
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport121A(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport121A(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
