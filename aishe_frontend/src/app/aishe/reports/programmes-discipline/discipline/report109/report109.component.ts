...
@Component({
  selector: 'app-report109',
  templateUrl: './report109.component.html',
  styleUrls: ['./report109.component.scss']
})
export class Report109Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.PostService.getReport109(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.PostService.getReport109(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.PostService.getReport109(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
