...
@Component({
  selector: 'app-report150b',
  templateUrl: './report150b.component.html',
  styleUrls: ['./report150b.component.scss']
})
export class Report150bComponent implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport150B(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports150B")
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport150B(this.reportFilterForm.value).pipe(
      finalize(() => {
