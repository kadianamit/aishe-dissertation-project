...
@Component({
  selector: 'app-report126b',
  templateUrl: './report126b.component.html',
  styleUrls: ['./report126b.component.scss']
})
export class Report126bComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport126B(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports126b")
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport126B(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport126B(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
