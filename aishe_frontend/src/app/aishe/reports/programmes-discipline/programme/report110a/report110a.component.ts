...
@Component({
  selector: 'app-report110a',
  templateUrl: './report110a.component.html',
  styleUrls: ['./report110a.component.scss']
})
export class Report110aComponent implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport110A(this.reportFilterForm.value).subscribe((res:any) => {
        let byteArrays = res.byteData;
        utility.downloadAsExcel(byteArrays,this.reportInfoObj.reportNumber);
  });
  }
  ngOnInit(): void {
    console.log("inside reports110a")
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport110A(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport110A(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
