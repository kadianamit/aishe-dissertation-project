...
@Component({
  selector: 'app-report38b',
  templateUrl: './report38b.component.html',
  styleUrls: ['./report38b.component.scss']
})
export class Report38bComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport38B(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  ngOnInit(): void {
    console.log("inside report38b");
  }
  getReportDataTable(): void {
    this.isDataLoading=true;
    this.reportFilterForm.value.reportType = "JSON";
    this.showPdfButton = true;
    this.getService.getReport38B(this.reportFilterForm.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    ...
    this.getService.getReport38B(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
