...
@Component({
  selector: 'app-report64',
  templateUrl: './report64.component.html',
  styleUrls: ['./report64.component.scss']
})
export class Report64Component implements OnInit, ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
  ...
  exportAsXLSX(): void {
    ...
    this.getService.getReport64(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getService.getReport64(this.reportFilterForm.value).pipe(
      finalize(() => {
