...
@Component({
  selector: 'app-report42',
  templateUrl: './report42.component.html',
  styleUrls: ['./report42.component.scss']
})
export class Report42Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.GetService.getReport42(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  // console.log(this.reportFilterForm.value);
   this.GetService.getReport42(this.reportFilterForm.value).pipe(
     finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.GetService.getReport42(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
