...
@Component({
  selector: 'app-report127c',
  templateUrl: './report127c.component.html',
  styleUrls: ['./report127c.component.scss']
})
export class Report127cComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.GetService.getReport127C(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  // console.log(this.reportFilterForm.value);
   this.GetService.getReport127C(this.reportFilterForm.value).pipe(
     finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.GetService.getReport127C(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
