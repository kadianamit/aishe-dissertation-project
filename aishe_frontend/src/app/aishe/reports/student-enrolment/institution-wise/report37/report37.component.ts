...
@Component({
  selector: 'app-report37',
  templateUrl: './report37.component.html',
  styleUrls: ['./report37.component.scss']
})
export class Report37Component implements OnInit , ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.ReportService.getReport37(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.ReportService.getReport37(this.reportFilterForm.value).pipe(
      finalize(() => {
