...
@Component({
  selector: 'app-report41',
  templateUrl: './report41.component.html',
  styleUrls: ['./report41.component.scss']
})
export class Report41Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport41(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport41
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport41(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
