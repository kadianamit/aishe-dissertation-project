...
@Component({
  selector: 'app-report127b',
  templateUrl: './report127b.component.html',
  styleUrls: ['./report127b.component.scss']
})
export class Report127bComponent implements OnInit, ReportChildComponent {
  ...
  constructor(private GetService:GetService,public sharedService:SharedService,public localService:LocalserviceService
                  ) {
  ...
  exportAsXLSX(): void {
    ...
    this.GetService.getReport127B(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  this.reportFilterForm.value=this.reportFilterForm.getRawValue();
   this.reportFilterForm.value.exportType = "JSON";
    this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.reportFilterForm.value.roleId= this.roleId
  // console.log(this.reportFilterForm.value);
   this.GetService.getReport127B(this.reportFilterForm.value).pipe(
     finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    this.reportFilterForm.value.exportType="PDF";
     this.reportFilterForm.value.universityId=this.splitAisheCode;
    this.GetService.getReport127B(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
