...
@Component({
  selector: 'app-report127a',
  templateUrl: './report127a.component.html',
  styleUrls: ['./report127a.component.scss']
})
export class Report127aComponent implements OnInit, ReportChildComponent {
...
reportTableData: any;
  ...
  exportAsXLSX(): void {
    ...
    this.GetService.getReport127A(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  this.reportFilterForm.value=this.reportFilterForm.getRawValue();
   ...
   console.log(this.reportFilterForm.value);
   this.GetService.getReport127A(this.reportFilterForm.value).pipe(
     finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.GetService.getReport127A(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
