...
@Component({
  selector: 'app-report36',
  templateUrl: './report36.component.html',
  styleUrls: ['./report36.component.scss']
})
export class Report36Component implements OnInit , ReportChildComponent {
  ...
  constructor(private ReportService:ReportService,public sharedService:SharedService,public localService:LocalserviceService
              ) {
  ...
  exportAsXLSX(): void {
    ...
    this.ReportService.getReport36(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.ReportService.getReport36(this.reportFilterForm.value).pipe(
      finalize(() => {
