...
@Component({
  selector: 'app-report108a',
  templateUrl: './report108a.component.html',
  styleUrls: ['./report108a.component.scss']
})
export class Report108aComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.ReportService.getReport108A(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    console.log(this.reportFilterForm.value);
    this.ReportService.getReport108A(this.reportFilterForm.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    ...
    this.ReportService.getReport108A(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
