...
@Component({
  selector: 'app-report107',
  templateUrl: './report107.component.html',
  styleUrls: ['./report107.component.scss']
})
export class Report107Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.PostService.getReport107(this.reportFilterForm.value).subscribe((res:any) => {
...
console.log("inside report107")
  ...
  getReportDataTable(): void {
    ...
    this.PostService.getReport107(this.reportFilterForm.value).pipe(
      finalize(() => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.PostService.getReport107(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
