...
@Component({
  selector: 'app-report108b',
  templateUrl: './report108b.component.html',
  styleUrls: ['./report108b.component.scss']
})
export class Report108bComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.ReportService.getReport108B(this.reportFilterForm.value).subscribe((res:any) => {
...
this.ReportService.getReport108B(this.reportFilterForm.value).pipe(
  finalize(() => {
  ...
  generatePDF(): void {
   ...
   this.ReportService.getReport108B(this.reportFilterForm.value).subscribe(res => {
       let byteArrays = res.byteData;
