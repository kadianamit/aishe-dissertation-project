...
@Component({
  selector: 'app-report39',
  templateUrl: './report39.component.html',
  styleUrls: ['./report39.component.scss']
})
export class Report39Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport39(this.reportFilterForm.value).subscribe((res:any) => {
...
console.log("inside report39")
  ...
  getReportDataTable(): void {
    ...
    this.postService.getReport39(this.reportFilterForm.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport39(this.reportFilterForm.value).subscribe(res => {
        let byteArrays = res.byteData;
