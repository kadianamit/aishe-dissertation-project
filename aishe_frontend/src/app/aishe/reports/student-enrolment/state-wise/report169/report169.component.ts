...
@Component({
  selector: 'app-report169',
  templateUrl: './report169.component.html',
  styleUrls: ['./report169.component.scss']
})
export class Report169Component implements OnInit ,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport169(this.reportFilterForm.value).subscribe((res:any) => {
...
console.log("inside report169")
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport169(this.reportFilterForm.value).pipe(
      finalize(() => {
