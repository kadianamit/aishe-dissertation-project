...
@Component({
  selector: 'app-report43',
  templateUrl: './report43.component.html',
  styleUrls: ['./report43.component.scss']
})
export class Report43Component implements OnInit ,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport43(this.reportFilterForm.value).subscribe((res:any) => {
...
console.log("inside report43")
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport43(this.reportFilterForm.value).pipe(
      finalize(() => {
