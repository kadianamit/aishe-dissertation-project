...
@Component({
  selector: 'app-report32a',
  templateUrl: './report32a.component.html',
  styleUrls: ['./report32a.component.scss']
})
export class Report32aComponent implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport32A(this.reportFilterForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport32A
