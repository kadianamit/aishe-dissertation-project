...
@Component({
  selector: 'app-report34',
  templateUrl: './report34.component.html',
  styleUrls: ['./report34.component.scss']
})
export class Report34Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport34(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport34
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport34(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
