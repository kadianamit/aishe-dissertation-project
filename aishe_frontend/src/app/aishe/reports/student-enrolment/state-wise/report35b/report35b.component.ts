...
@Component({
  selector: 'app-report35b',
  templateUrl: './report35b.component.html',
  styleUrls: ['./report35b.component.scss']
})
export class Report35bComponent implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.postService.getReport35b(this.reportFilterForm.value).subscribe((res:any) => {
...
console.log("inside report35b")
  ...
  getReportDataTable() {
    ...
    this.postService.getReport35b(this.reportFilterForm.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    this.reportFilterForm.value.reportType="PDF";
      this.postService.getReport35b(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
