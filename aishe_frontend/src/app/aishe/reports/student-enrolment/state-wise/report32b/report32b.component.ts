...
@Component({
  selector: 'app-report32b',
  templateUrl: './report32b.component.html',
  styleUrls: ['./report32b.component.scss']
})
export class Report32bComponent implements OnInit, ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport32B(this.reportFilterForm.value).subscribe(
     (res:any) => {
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport32B(this.reportFilterForm.value).subscribe((res:any) => {
