...
@Component({
  selector: 'app-report170',
  templateUrl: './report170.component.html',
  styleUrls: ['./report170.component.scss']
})
export class Report170Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport170(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport170
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport170(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
