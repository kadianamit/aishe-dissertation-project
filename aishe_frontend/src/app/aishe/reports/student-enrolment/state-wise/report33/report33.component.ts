...
@Component({
  ...
  styleUrls: ['./report33.component.scss']
})
export class Report33Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportService.getReport33(this.reportFilterForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportService.getReport33
  ...
  generatePDF(): void {
    ...
    this.reportService.getReport33(this.reportFilterForm.value).subscribe(res => {
          let byteArrays = res.byteData;
