...
@Component({
  selector: 'app-report134a',
  templateUrl: './report134a.component.html',
  styleUrls: ['./report134a.component.scss']
})
export class Report134aComponent implements OnInit, ReportChildComponent {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
   ...
   // this.showPdfButton = true;
    this.getService.getReport134A(this.reportFilterForm.value).pipe(
      finalize(() => {
