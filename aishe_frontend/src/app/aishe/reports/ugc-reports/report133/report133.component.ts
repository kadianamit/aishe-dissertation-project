...
@Component({
  selector: 'app-report133',
  templateUrl: './report133.component.html',
  styleUrls: ['./report133.component.scss']
})
export class Report133Component implements OnInit , ReportChildComponent {
  @Input("reportInfoObj")
  reportInfoObj: any;
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport133(this.reportFilterForm.value,this.inputObj).subscribe((res:any) => {
...
this.reportFilterForm.value=this.reportFilterForm.getRawValue();
    ...
    this.getService.getReport133(this.reportFilterForm.value,this.inputObj).pipe(
      finalize(() => {
