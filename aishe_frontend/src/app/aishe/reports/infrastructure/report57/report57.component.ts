...
@Component({
  selector: 'app-report57',
  templateUrl: './report57.component.html',
  styleUrls: ['./report57.component.scss']
})
export class Report57Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport57(this.reportForm.value).subscribe(res => {
...
getReportDataTable(): void {
    ...
    this.getReport.getReport57(this.reportForm.value).pipe(
      finalize(() => {
