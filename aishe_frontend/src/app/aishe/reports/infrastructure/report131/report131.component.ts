...
@Component({
  selector: 'app-report131',
  templateUrl: './report131.component.html',
  styleUrls: ['./report131.component.scss']
})
export class Report131Component implements OnInit ,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport131(this.reportForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport131(this.reportForm.value).pipe(
      finalize(() => {
