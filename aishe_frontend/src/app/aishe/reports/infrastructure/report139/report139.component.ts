...
@Component({
  selector: 'app-report139',
  templateUrl: './report139.component.html',
  styleUrls: ['./report139.component.scss']
})
export class Report139Component implements OnInit ,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport139(this.reportForm.value).subscribe((res:any) => {
  ...
  //  this.isDataLoading=true;
   this.reportForm.value=this.reportForm.getRawValue();
    ...
    this.getReport.getReport139(this.reportForm.value).pipe(
      finalize(() => {
