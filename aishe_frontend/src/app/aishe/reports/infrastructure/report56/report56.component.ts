...
@Component({
  selector: 'app-report56',
  templateUrl: './report56.component.html',
  styleUrls: ['./report56.component.scss']
})
export class Report56Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport56(this.reportForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.reportForm.value.reportType = "JSON";
     this.reportForm.value.universityId=this.splitAisheCode
    this.getReport.getReport56(this.reportForm.value).pipe(
      finalize(() => {
