...
@Component({
  selector: 'app-report111b',
  templateUrl: './report111b.component.html',
  styleUrls: ['./report111b.component.scss']
})
export class Report111bComponent implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.reportForm.value.reportType="EXCEL";
      this.getReport.getReport111B(this.reportForm.value).subscribe(res => {
  ...
  ngOnInit(): void {
    console.log("inside reports111b")
  ...
  getReportDataTable(): void {
   ...
   // this.isDataLoading=true;
    ...
    this.getReport.getReport111B(this.reportForm.value).pipe(
      finalize(() => {
