...
@Component({
  selector: 'app-report111',
  templateUrl: './report111.component.html',
  styleUrls: ['./report111.component.scss']
})
export class Report111Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport111(this.reportForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport111(this.reportForm.value).pipe(
      finalize(() => {
