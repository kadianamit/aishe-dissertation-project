...
@Component({
  selector: 'app-report140',
  templateUrl: './report140.component.html',
  styleUrls: ['./report140.component.scss']
})
export class Report140Component implements OnInit ,ReportChildComponent {
...
splitAisheCode:any;
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport140(this.reportForm.value).subscribe((res:any) => {
  ...
  getReportDataTable(): void {
    ...
    this.reportForm.value.universityId=this.splitAisheCode
    this.getReport.getReport140(this.reportForm.value).pipe(
      finalize(() => {
