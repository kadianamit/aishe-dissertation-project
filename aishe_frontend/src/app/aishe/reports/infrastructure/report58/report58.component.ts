...
@Component({
  selector: 'app-report58',
  templateUrl: './report58.component.html',
  styleUrls: ['./report58.component.scss']
})
export class Report58Component implements OnInit, ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport58(this.reportForm.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport58(this.reportForm.value).pipe(
      finalize(() => {
