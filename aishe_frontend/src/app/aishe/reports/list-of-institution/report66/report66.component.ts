...
@Component({
  ...
  templateUrl: './report66.component.html',
  styleUrls: ['./report66.component.scss']
})
export class Report66Component implements OnInit,ReportChildComponent {
...
this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport66(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
   ...
   this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport66(this.reportFormlistofInst.value).pipe(
      finalize(() => {
        ...
        if (res.list.length > 0) {
          ...
          // console.log('is2021', this.is2021);
          // console.log('is2020', this.is2020);
