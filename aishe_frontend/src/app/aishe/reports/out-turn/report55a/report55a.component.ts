...
@Component({
  selector: 'app-report55a',
  templateUrl: './report55a.component.html',
  styleUrls: ['./report55a.component.scss']
})
export class Report55aComponent implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReportService.getReport55a(this.reportFormOutTurn.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReportService.getReport55a(this.reportFormOutTurn.value).pipe(
      finalize(() => {
