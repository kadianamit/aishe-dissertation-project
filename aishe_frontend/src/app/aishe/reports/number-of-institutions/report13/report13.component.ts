...
export class Report13Component  implements OnInit, ReportChildComponent {
  ...
  this.reportFilterForm.value = this.reportFilterForm.getRawValue();
    ...
    this.reportService.getMgmtwiseNumberOfInstitutionUniversityPdf(this.reportFilterForm.value).subscribe(res => {
  ...
  this.reportFilterForm.value = this.reportFilterForm.getRawValue();
    ...
    this.reportService.getMgmtwiseNumberOfInstitutionUniversity(this.reportFilterForm.value).pipe(
      finalize(() => {
