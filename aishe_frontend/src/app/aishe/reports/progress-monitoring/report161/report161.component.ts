...
@Component({
  selector: 'app-report161',
  templateUrl: './report161.component.html',
  styleUrls: ['./report161.component.scss']
})
export class Report161Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport161(this.reportFormlistofInst.value).subscribe(res => {
  ...
  this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport161(this.reportFormlistofInst.value).pipe(
      finalize(() => {
