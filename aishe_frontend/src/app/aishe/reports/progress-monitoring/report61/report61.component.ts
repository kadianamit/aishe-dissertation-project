...
@Component({
  selector: 'app-report61',
  templateUrl: './report61.component.html',
  styleUrls: ['./report61.component.scss']
})
export class Report61Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport61(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
   this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport61(this.reportFormlistofInst.value).pipe(
      finalize(() => {
