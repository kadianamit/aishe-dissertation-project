...
@Component({
  selector: 'app-report60',
  templateUrl: './report60.component.html',
  styleUrls: ['./report60.component.scss']
})
export class Report60Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport60(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
   this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport60(this.reportFormlistofInst.value).pipe(
      finalize(() => {
