...
@Component({
  selector: 'app-report162',
  templateUrl: './report162.component.html',
  styleUrls: ['./report162.component.scss']
})
export class Report162Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport162(this.reportFormlistofInst.value).subscribe(res => {
  ...
  this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport162(this.reportFormlistofInst.value).pipe(
      finalize(() => {
