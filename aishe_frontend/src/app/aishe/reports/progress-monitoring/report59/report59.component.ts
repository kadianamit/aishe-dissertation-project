...
@Component({
  selector: 'app-report59',
  templateUrl: './report59.component.html',
  styleUrls: ['./report59.component.scss']
})
export class Report59Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport59(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
   this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport59(this.reportFormlistofInst.value).pipe(
      finalize(() => {
