...
@Component({
  selector: 'app-report96',
  templateUrl: './report96.component.html',
  styleUrls: ['./report96.component.scss']
})
export class Report96Component implements OnInit,ReportChildComponent {
  ...
  constructor(private getReport:GetService , private sharedService:SharedService) { }
  exportAsXLSX(): void {
    this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    this.reportFormlistofInst.value.exportType="EXCEL";
    this.getReport.getReport96(this.reportFormlistofInst.value).subscribe(res => {
 ...
 this.reportFormlistofInst.value=this.reportFormlistofInst.getRawValue();
    ...
    this.getReport.getReport96(this.reportFormlistofInst.value).pipe(
      finalize(() => {
