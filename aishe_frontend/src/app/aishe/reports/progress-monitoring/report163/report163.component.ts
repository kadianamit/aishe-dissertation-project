...
@Component({
  selector: 'app-report163',
  templateUrl: './report163.component.html',
  styleUrls: ['./report163.component.scss']
})
export class Report163Component implements OnInit,ReportChildComponent {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport163(this.reportFormlistofInst.value).pipe(
      finalize(() => {
  ...
  generatePDF(): void {
    ...
    this.getReport.getReport163(this.reportFormlistofInst.value).subscribe(res => {
