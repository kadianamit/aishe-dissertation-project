...
@Component({
  selector: 'app-report47c',
  templateUrl: './report47c.component.html',
  styleUrls: ['./report47c.component.scss']
})
export class Report47cComponent implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport47C(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport47C(this.reportFormlistofInst.value).pipe(
      finalize(() => {
