...
@Component({
  selector: 'app-report47b',
  templateUrl: './report47b.component.html',
  styleUrls: ['./report47b.component.scss']
})
export class Report47bComponent implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport47B(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport47B(this.reportFormlistofInst.value).pipe(
      finalize(() => {
