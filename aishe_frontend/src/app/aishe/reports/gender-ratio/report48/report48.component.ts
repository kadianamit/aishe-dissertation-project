...
@Component({
  selector: 'app-report48',
  templateUrl: './report48.component.html',
  styleUrls: ['./report48.component.scss']
})
export class Report48Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport48(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport48(this.reportFormlistofInst.value).pipe(
      finalize(() => {
