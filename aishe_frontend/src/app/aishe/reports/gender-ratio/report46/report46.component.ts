...
@Component({
  selector: 'app-report46',
  templateUrl: './report46.component.html',
  styleUrls: ['./report46.component.scss']
})
export class Report46Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport46(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport46(this.reportFormlistofInst.value).pipe(
      finalize(() => {
