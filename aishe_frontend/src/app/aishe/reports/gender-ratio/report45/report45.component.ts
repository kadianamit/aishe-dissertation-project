...
@Component({
  selector: 'app-report45',
  templateUrl: './report45.component.html',
  styleUrls: ['./report45.component.scss']
})
export class Report45Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport45(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport45(this.reportFormlistofInst.value).pipe(
      finalize(() => {
