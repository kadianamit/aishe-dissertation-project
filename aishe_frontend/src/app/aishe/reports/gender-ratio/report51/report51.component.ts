...
@Component({
  selector: 'app-report51',
  templateUrl: './report51.component.html',
  styleUrls: ['./report51.component.scss']
})
export class Report51Component implements OnInit,ReportChildComponent {
...
splitAisheCode:any;
  ...
  constructor(private getReport:GetService,public sharedService:SharedService,public localService: LocalserviceService) { 
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport51(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    //  this.reportFormlistofInst.value.universityId=this.splitAisheCode;
    this.getReport.getReport51(this.reportFormlistofInst.value).pipe(
      finalize(() => {
