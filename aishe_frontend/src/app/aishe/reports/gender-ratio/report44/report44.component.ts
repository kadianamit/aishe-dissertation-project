...
@Component({
  selector: 'app-report44',
  templateUrl: './report44.component.html',
  styleUrls: ['./report44.component.scss']
})
export class Report44Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport44(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport44(this.reportFormlistofInst.value).pipe(
      finalize(() => {
