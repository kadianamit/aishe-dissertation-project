...
@Component({
  selector: 'app-report51a',
  templateUrl: './report51a.component.html',
  styleUrls: ['./report51a.component.scss']
})
export class Report51aComponent implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport51A(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport51A(this.reportFormlistofInst.value).pipe(
      finalize(() => {
