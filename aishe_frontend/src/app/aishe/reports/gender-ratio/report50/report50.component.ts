...
@Component({
  selector: 'app-report50',
  templateUrl: './report50.component.html',
  styleUrls: ['./report50.component.scss']
})
export class Report50Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport50(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport50(this.reportFormlistofInst.value).pipe(
      finalize(() => {
