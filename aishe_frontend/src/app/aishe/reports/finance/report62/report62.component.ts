...
@Component({
  selector: 'app-report62',
  templateUrl: './report62.component.html',
  styleUrls: ['./report62.component.scss']
})
export class Report62Component implements OnInit,ReportChildComponent {
  ...
  exportAsXLSX(): void {
    ...
    this.getReport.getReport62(this.reportFormlistofInst.value).subscribe(res => {
  ...
  getReportDataTable(): void {
    ...
    this.getReport.getReport62(this.reportFormlistofInst.value).pipe(
      finalize(() => {
