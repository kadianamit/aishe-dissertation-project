...
export class CollegeToUniversityComponent implements OnInit {
  ...
  surveyYear:number=0
  tableHeaders = ['SNO','Survey Year', 'AISHE Code', 'Institute Name','State','AISHE Code','University','Remarks','Action By','Action Time'];
...
if(collegeToUniversityCode){
  ...
  downloadPDF() {
    ...
    let param={
      ...
      tableData:tableData,
      pdfName:'College-to-University Insitutions',
      downloadPdfName:'List of College-to-University Insitutions.pdf'
    }
  ...
  downloadExcel() {
    ...
    let param={
      tableHeaders:this.tableHeaders,
      tableData:tableData,
      downloadExcelName:'List of College-to-University Insitutions'
    }
