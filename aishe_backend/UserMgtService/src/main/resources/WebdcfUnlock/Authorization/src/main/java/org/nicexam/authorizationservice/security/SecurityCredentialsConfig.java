...
//		 .antMatchers("/reg/auth/eIdeas/**").permitAll()
		 .antMatchers("/auth/users/**").permitAll()
//		 .antMatchers("/reg/auth/eIdeasp/**").permitAll()
//		 .antMatchers("/reg/eIdeas/**").permitAll()
		 .antMatchers("/auth/login/**").permitAll()
	//	 .antMatchers("/auth/captcha/**").permitAll()
	//	 .antMatchers("/auth/teachers/**").permitAll()
...
//	
		...
		System.out.println("Login URL:::"+jwtConfig.getUri());
