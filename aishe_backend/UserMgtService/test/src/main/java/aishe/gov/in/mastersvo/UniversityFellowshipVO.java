...
public class UniversityFellowshipVO {
	private Integer Id;
	private Integer surveyYear;
	private String universityId;
	private Boolean hasInstitutionMaintainFellowShipData;
	...
	public Boolean getHasInstitutionMaintainFellowShipData() {
		return hasInstitutionMaintainFellowShipData;
	}
	public void setHasInstitutionMaintainFellowShipData(Boolean hasInstitutionMaintainFellowShipData) {
		this.hasInstitutionMaintainFellowShipData = hasInstitutionMaintainFellowShipData;
	}
