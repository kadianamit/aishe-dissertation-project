...
public class RegularStudentEnrollment {
...
//	private String department;
	...
	@JoinTable(name="enrolled_regular_student_count",
	joinColumns =@JoinColumn(name="enrolled_regular_student_id",referencedColumnName = "id"),
